...
stmt = select([func.count(census.columns.state.distinct())]) #remember '.columns'
...
if use fetchall(), the result is :
[In]	distinct_state_count = connection.execute(stmt).fetchall()
[Out]  [(51,)]
'''