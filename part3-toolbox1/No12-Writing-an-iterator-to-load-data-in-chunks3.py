...
#***df_pop_ceb['Total Urban Population'] = [int(v) for v in df_pop_ceb['Total Urban Population']]

df_pop_ceb['Total Urban Population'] = [int(v[1]*v[0]*0.01) for v in pops_list]

# Plot urban population data
#***df_pop_ceb.plot(kind=scatter, x='Year', y='Total Urban Population')   error:  scatter forget ''
