...
'''my note
example 1:
# Create a 7 x 4 matrix using a list of lists: matrix
matrix = [[col for col in range(2,9)] for row in range(2,6)]   
# the first range(2,9) control the value of element, the second range(2,6) only control the number of rows.
