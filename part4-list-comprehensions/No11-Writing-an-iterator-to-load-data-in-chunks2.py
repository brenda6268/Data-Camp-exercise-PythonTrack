...
#***df_pop_ceb = df_urb_pop[df_urb_pop['CountryCode']='CEB']     Error '=' should be '=='
df_pop_ceb = df_urb_pop[df_urb_pop['CountryCode']=='CEB']
# Zip DataFrame columns of interest: pops
#hint: df_pop_ceb['Total Population']?

#***Error:  pops = zip('Total Population', 'Urban population (% of total)')
